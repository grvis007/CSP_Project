...
public class callofduty extends HttpServlet {
	protected void doGet(HttpServletRequest request,
    	...
    	"<ul>"+
			...
			"</li></ul></nav>");	//"<li class=''><a href='login.html'>Sign In</a></li><li class=''><a href='register.html'>Create Account</a></li></ul></nav>");	   
		...
		"</nav>"+
		"</footer>");
		String searchParameter = "callofduty";
