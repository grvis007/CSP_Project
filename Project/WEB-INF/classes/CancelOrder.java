	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try{
			...
			if(i<5){
				...
				DBCollection CancelOrders = db.getCollection("CancelOrders");
				BasicDBObject doc1 = new BasicDBObject("title", "CancelOrders").
				append("orderid", searchParameter).
				append("currentdate", date2);
				CancelOrders.insert(doc1);	
			}
			out.println("</tr>");
