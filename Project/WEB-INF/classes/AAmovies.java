...
public class AAmovies extends HttpServlet {
	protected void doGet(HttpServletRequest request,
		...
		out.println("<span ><ul class=''></ul></span></header>");
		out.println("<nav>"+
    	"<ul>"+
			...
			"<li class=''><a href='#'></a></li><li class=''><a href='help.html'>Help</a></li>"+               
		...
		String searchParameter = "Action&AdventourousMovies";
