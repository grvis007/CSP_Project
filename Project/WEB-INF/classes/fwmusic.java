...
public class fwmusic extends HttpServlet {
	protected void doGet(HttpServletRequest request,
		...
		"</nav>"+
		"</footer>");
		String searchParameter = "Folk_Music";
		...
		BasicDBObject searchQuery = new BasicDBObject();
				...
				//out.println("<img src="+obj.getString("imagepath")+" alt='myimg' width=300px height=150px ><br/>");
				out.println("<br/>");
				out.println("<br/>");
				out.println("<br/>");
				out.println("<br/>");
